...
const setPrices = (btn, reduce) => {
    ...
    if(!reduce){
        ...
        if(btn.classList.contains("economy-seat-button")){
            base_price_element.value = parseFloat(base_price_element.value) + parseFloat(economy_price)
            final_price_element.value = parseFloat(final_price_element.value)+parseFloat(after_discount_economy_price)
        }else if(btn.classList.contains("business-seat-button")){
            base_price_element.value = parseFloat(base_price_element.value) + parseFloat(business_price)
            final_price_element.value = parseFloat(final_price_element.value)+parseFloat(after_discount_business_price)
        }else if(btn.classList.contains("platinum-seat-button")){
            base_price_element.value = parseFloat(base_price_element.value) + parseFloat(platinum_price)
            final_price_element.value = parseFloat(final_price_element.value)+parseFloat(after_discount_platinum_price)
        }
    }else{
        if(btn.classList.contains("economy-seat-button")){
            base_price_element.value = parseFloat(base_price_element.value) - parseFloat(economy_price)
