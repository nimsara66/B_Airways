...
class RegisteredCustomer {
  ...
  static getFrequency(customerId, interval) {
    return db.query(
      'SELECT COUNT(*) as frequency FROM Seat_Booking ' +
        'WHERE customer_id = ? and booking_date > DATE_SUB(CURRENT_DATE(), INTERVAL ? DAY)',
      [customerId, interval]
    )
  }
}
